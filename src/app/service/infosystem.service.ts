...
export class InfosystemService {
  ...
  // private nameSource = new BehaviorSubject<boolean>(false);
  // name = this.nameSource.asObservable()
  // changeName(name: boolean) {
  //   this.nameSource.next(name);
  // }
  // private isAdmin = new BehaviorSubject<boolean>(false);
  // isadminrole = this.isAdmin.asObservable()
  // changeroletoAdmin(isadminrole: boolean) {
  //   this.isAdmin.next(isadminrole);
  // }
